...
@Component({
  selector: 'sfa-sales-reps-create-update',
  templateUrl: './sales-reps-create-update.component.html',
  styleUrls: ['./sales-reps-create-update.component.scss'],
})
export class SalesRepsCreateUpdateComponent implements OnInit {
  form: FormGroup;
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<SalesRepsCreateUpdateComponent>,
