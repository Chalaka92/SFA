...
export type Theme = 'sfa-default' | 'sfa-light' | 'sfa-dark' | 'sfa-flat';
...
export class ThemeService {
  ...
  private _themeSubject = new BehaviorSubject<[Theme, Theme]>([null, 'sfa-default']);
  ...
  setStyle(style: 'default' | 'flat' | 'dark' | 'light' | 'top' | string) {
    switch (style) {
      case 'flat': {
        ...
        this.setTheme('sfa-flat');
        break;
      }

      case 'dark': {
        this.setTheme('sfa-dark');
        break;
      }
